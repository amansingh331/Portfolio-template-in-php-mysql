...
<head>
  ...
  <title><?=$data['title']?>-->Blog-tag</title>
...
<?php include('include/header.php'); ?>  
  ...
  <main id="main">
    ...
    <section id="blog" class="blog">
      ...
      <?php
      $query5 = "SELECT * FROM blog WHERE tag='$blog_tag_name2' ORDER BY blog_id DESC LIMIT $start_from,$num_per_page";
      ...
      ?>
        ...
        <?php 
        $pr_query = "select * from blog WHERE tag='$blog_tag_name2'";
        $pr_result = mysqli_query($db,$pr_query);
        $total_record = mysqli_num_rows($pr_result );
        $total_page = ceil($total_record/$num_per_page);
        if($page>1)
        {
            echo "<li><a href='blog-tag.php?tag=".$blog_tag_name2."&page=".($page-1)."'>Previous</a></li>";
        }
        echo "<li class='active'><a href='blog-tag.php?tag=".$blog_tag_name2."&page=".($page)."'>$page</a></li>";
        ...
        if($i>$page)
        {
            echo "<li><a href='blog-tag.php?tag=".$blog_tag_name2."&page=".($page+1)."' >Next</a></li>";
        }
        ?>
              </ul>
            </div>

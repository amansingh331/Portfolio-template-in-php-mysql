      ...
      <div class="sidebar-sticky pt-3">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="?editcomment=true">
              <span data-feather="archive"></span>
              Edit comment
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?editcategory=true">
              <span data-feather="archive"></span>
              Edit category
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?edittag=true">
              <span data-feather="archive"></span>
              Edit tag
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?edituser_info=true">
              <span data-feather="archive"></span>
              user info
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?editchat_info=true">
              <span data-feather="archive"></span>
              chat info
            </a>
          </li>
...
<?php
     ...
     }else if(isset($_GET['edittag'])){
       include('php/tag.php');
     }else if(isset($_GET['edituser_info'])){
       include('php/user_info.php');
     }else if(isset($_GET['editchat_info'])){
       include('php/chat_info.php');
